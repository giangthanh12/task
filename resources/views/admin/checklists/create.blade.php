...
<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="card">
            ...
            @endif
            <form action="{{route("admin.checklist_groups.checklists.store", $checklistGroup->id)}}" method="post">
                @csrf
                ...
                <div class="card-body">
                    <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-739">
                        <div class="mb-3">
                          ...
                          <input class="form-control" id="name" name="name" type="name" placeholder="{{ __("Checklist name")}}">
                        </div>
                      </div>
                </div>
